...
def checkCollision():
    if p1.x < ball.x and p1.y < ball.y and p1.x + p1.racketsizex \
        > ball.x and p1.y + p1.racketsizey > ball.y:  # if hit racket
    ...
    if p2.x < ball.x and p2.y < ball.y and p2.x + p2.racketsizex \
        > ball.x and p2.y + p2.racketsizey > ball.y:  # same stuff, but for p2's racket
